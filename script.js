      ...
      if (isValid) {
        ...
        fetch(action, options)
          ...
          .then(function() {
            ...
            successMsg.style.cssText = 'color: #38a169; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #f0fff4; border-radius: 0.375rem; text-align: center;';
          ...
          .catch(function(error) {
            ...
            errorMsg.style.cssText = 'color: #e53e3e; font-size: 1rem; margin-top: 1rem; padding: 0.75rem; background: #fff5f5; border-radius: 0.375rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1e374aaa-f490-4d53-9867-282feb75d7b7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1e374aaa-f490-4d53-9867-282feb75d7b7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1e374aaa-f490-4d53-9867-282feb75d7b7';
